...
data = dict(
    ...
    train=dict(
        type='DOTADataset',
        task='Task1',
        ann_file='data/DOTA_2_0_split_default/train/part4/trainval/annfiles/',
        img_prefix='data/DOTA_2_0_split_default/train/part4/trainval/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='LoadOBBAnnotations',
    ...
    test=dict(
        type='DOTADataset',
        task='Task1',
        ann_file='data/DOTA_2_0_split_default/train/part4/test/annfiles/',
        img_prefix='data/DOTA_2_0_split_default/train/part4/test/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipRotateAug',
...
test_cfg = dict(
    ...
    rcnn=dict(
        ...
        max_per_img=2000))
work_dir = './work_dirs/faster_rcnn_orpn_r50_fpn_1x_ms_rr_dota10'
gpu_ids = range(0, 1)
